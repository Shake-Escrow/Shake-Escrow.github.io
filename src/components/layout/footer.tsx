      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col items-start space-y-2">
            ...
            <div className="font-semibold text-lg font-body text-[#2d3440] mb-1 break-words text-left">Enabling crypto’s usability for everyday transactions</div>
            <div className="text-small font-body text-[#2d3440] opacity-70 mt-1 text-left">Shake Defi, Inc. is a corporation organized under the laws of the State of Wisconsin.</div>
          </div>
